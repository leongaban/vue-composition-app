...
<template>
  <div>
    ...
    <Modal v-model="showModal" title="My Modal Title" :btn-style="btnStyleDark">
      <!-- <template #title>My new title</template> -->
      <p>
        Lorem, ipsum dolor sit amet consectetur adipisicing elit. Vel tempora
        quibusdam tenetur, debitis autem fugit a nesciunt mollitia ipsa
        inventore nostrum perspiciatis neque dolor id magnam facere eum
        similique? Adipisci.
      </p>
    </Modal>
  </div>
